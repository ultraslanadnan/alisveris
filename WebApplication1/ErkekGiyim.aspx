<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="ErkekGiyim.aspx.cs" Inherits="WebApplication1.ErkekGiyim" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <h2>Yeni & Sezon <small>Sonbahar Sezonu Erkek Tüm Ürünler</small></h2>
           </div>
      <div class="row">
    ...
    <ItemTemplate>
           ...
           <div style="border:0.3px solid black;"  class="product-image-wrapper">
                                <div  class="single-products">
                                    <div   class="productinfo text-center">
                                            <asp:LinkButton runat="server" id="incele_butonu_resim" CommandArgument='<%# Eval("URUN_ID") %>' OnCommand="incele_butonu_ErkekGiyim_Command">
                                ...
                                <div style="border:0.3px solid black;"  class="choose">
                                    <ul class="nav nav-pills nav-justified">
                                        <li><<asp:LinkButton runat="server" id="incele_butonu_ErkekGiyim" CommandArgument='<%# Eval("URUN_ID") %>' OnCommand="incele_butonu_ErkekGiyim_Command" ><i  class="fa fa-plus-square"></i>İncele</asp:LinkButton></li>
                            </ul>
                                </div>
                            </div>
      </div>
          ...
          <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM &quot;temp_urunler&quot;  WHERE KATEGORI_ADI = 'ErkekGiyim'"></asp:SqlDataSource>
